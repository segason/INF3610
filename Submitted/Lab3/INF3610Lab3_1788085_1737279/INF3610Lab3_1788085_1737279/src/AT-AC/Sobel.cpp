...
unsigned int Sobel::Read(const unsigned int addressRD)
{
	int receivedData = 0;
	...
	receivedData = data.read();
	requestRead.write(false);

	return receivedData;
}

void Sobel::Write(const unsigned int addressWR, const unsigned int dataWR)
{
